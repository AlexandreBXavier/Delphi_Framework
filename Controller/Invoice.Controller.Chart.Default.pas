unit Invoice.Controller.Chart.Default;

interface

uses Invoice.Controller.Interfaces, System.Classes, System.SysUtils, Vcl.OleCtrls, Vcl.Forms, ActiveX, SHDocVw;
...
procedure TControllerChartDefault.ShowChart(aWebBrowser: TWebBrowser);
var
...
begin
     ...
     try
          ...
          aChart.Add('      google.charts.load("current", {packages:["corechart"]});');
          ...
          aChart.Add('          title: ' + QuotedStr(FChartTitle) + ',');
          aChart.Add('          subtitle: ' + QuotedStr(FChartSubTitle) + ',');
          aChart.Add('          pieHole: 0.4,');
          aChart.Add('        };');
